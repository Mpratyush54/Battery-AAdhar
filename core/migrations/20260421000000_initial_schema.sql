...
CREATE INDEX IF NOT EXISTS idx_recycling_certifications_bpan ON recycling_certifications(bpan);

CREATE INDEX IF NOT EXISTS idx_reuse_certifications_bpan ON reuse_certifications(bpan);
